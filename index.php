    ...
    <div class="container bg-white p-4 rounded shadow my-4" style="max-width: 600px;">
        ...
        <form action="process.php" method="POST">
            <div class="form-group">
                ...
                <textarea id="ingredients" class="form-control mb-2" name="ingredients" rows="4" required placeholder="bijv. ui, knoflook, tomaat, pasta"></textarea>
            </div>
            <button type="submit" class="btn btn-primary">Genereer Recept</button>
        </form>
